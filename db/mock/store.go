...
// Source: github.com/wizlif/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTxn(arg0 context.Context, arg1 db.TransferParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
